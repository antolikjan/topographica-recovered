...
def _divide_with_constant(x, y):
    ...
    return numpy.divide(x, y + __main__.__dict__.get('LGNGain',0.18))
...
def AddGC(surround_gaussian_size=__main__.__dict__.get('SurrSize',0.3), strength=__main__.__dict__.get('LatLGNStr',0.5)):
